# Django settings for rapidsms_plugin project.
...
PROJECT_PATH = os.path.join(PROJECT_ROOT, 'rapidsms_plugin')
...
SECRET_KEY = '_8k#19qh!ngsa3z6+e4c)^^x^v=%cvs(oce$a1k5eq5r9s4z$*'
...
ROOT_URLCONF = 'rapidsms_plugin.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'rapidsms_plugin.wsgi.application'
